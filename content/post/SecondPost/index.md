...
Je vous laisse ci-dessous le texte original remplis d'humour [TODO: text p22]
...
{{< figure
    src="lifeOnTheFourIncomeLevels.jpg"
    >}}
...
L'auteur montre la répartition dans le monde de la population et de ces niveau de vie. Il ce permet même de faire des projections dans le futur. 

{{< figure
    src="Peoplebyregionandincome.jpg"
    >}}
...
{{< figure
    src="factfulness-poster-web-images-20180215-v3_Rules-of-thumb.jpg"
    alt=""
    >}}
...
Ce livre est remplis d'annecdote, souvent tiré de la propre experiance de l'auteur, qui à la fois illustre les 10 biais cognitif, et à la fois nous rapporte des expériances. Je vous résume ici celles qui m'ont le plus marqué. 

### La suède des année 1921 ==NEGATIVITY==

{{< figure
    src="swedenInTime.jpg"
    >}}
...
{{< figure
    src="Birth_rate_in_China_fr.png"
